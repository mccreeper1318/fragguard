...
- Fixed #41 by hiding prepared rollback audits until their mutation is confirmed, durably linking them to job changes, and preserving physics-normalized states and completed mutations across crashes, runtime failures, preparation/retry failures, post-mutation snapshot errors, or force-revalidation exhaustion.
